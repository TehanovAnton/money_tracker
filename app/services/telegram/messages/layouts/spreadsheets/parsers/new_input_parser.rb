...
module Telegram
  module Messages
    module Layouts
      module Spreadsheets
        module Parsers
          class NewInputParser < ParserBase
            string :layout_klass, default: 'Telegram::Messages::Layouts::Spreadsheets::Layouts::New'
            ...
            def parsed_input
              ...
              return parsed unless action_name == :enter_spreadsheets_params
