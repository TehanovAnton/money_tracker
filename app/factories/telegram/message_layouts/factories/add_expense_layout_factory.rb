    ...
    module Factories
      class AddExpenseLayoutFactory < ::Abstract::AbstractFactory
        ...
        def input_parser_factory(factory_name)
          Telegram::MessageLayouts::Factories::AddExpenseLayoutInputParserFactory.run!(
            factory_name: factory_name, style: :initializer
          )
        end

        def text_preparation_factory(factory_name, text)
          Telegram::MessageLayouts::Factories::AddExpenseLayoutTextPreparationFactory.run!(
        ...
        def layout_params_factory(factory_name, parsed_input)
          Telegram::MessageLayouts::Factories::AddExpenseLayoutParamsFactory.run!(
            factory_name: factory_name,
