...
module Parsers
  class DefaultParameters < Dry::Struct
    ...
    KindType = Telegram::AddExpenseInputParser::BaseParser::Types::Symbol.enum(*ALLOWED_PARSER_KINDS)
    InputKindType = Telegram::AddExpenseInputParser::BaseParser::Types::Symbol.enum(*ALLOWED_INPUT_KINDS)
    InlineParametersType = Telegram::AddExpenseInputParser::BaseParser::Types::Array.of(InputKindType)
